...
class PagarMe_Checkout_Block_Form_CheckoutTest extends PHPUnit_Framework_TestCase
{
    ...
    public function mustReturnCheckoutConfig()
    {
        $checkoutConfig = [
            ...
            'interestRate' => Mage::getStoreConfig('payment/pagarme_settings/credit_card_interest_rate'
            ),
            'maxInstallments' => Mage::getStoreConfig('payment/pagarme_settings/credit_card_max_installments'
            ),
            'freeInstallments' => Mage::getStoreConfig('payment/pagarme_settings/credit_card_free_installments'
            )
        ];
        ...
        \Mage::app()->getStore()->setConfig(
            'payment/pagarme_settings/credit_card_allowed_credit_card_brands',
            $this->brands
        );
